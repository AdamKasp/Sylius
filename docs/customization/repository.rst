...
As you can see in the ``_sylius.yaml`` you already have a basic configuration. Now you need to configure your custom repository as a resource's repository:
...
You can now use your method anywhere you are operating on the Product repository.
For example you can configure a new route:
